 ...
 * @Description:主题交换机消费者一号
 * @Author: leichengxu
 * @Date:2020-08-18 15:16
 */
public class topicExchangeConsumerOne {
  ...
  public static void main(String[] args) throws IOException, TimeoutException {
    Channel channel = rabbitMqConnectionUtil.getChannel("主题交换机消费者一号信道");
    channel.queueDeclare(QUEUE_NAME, false, false, false, null);
    channel.queueBind(QUEUE_NAME, EXCHANGE, "key.#", null);
    DefaultConsumer consumer = new DefaultConsumer(channel) {
      @Override
      public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties, byte[] body) {
        System.out.println("主题交换机消费者一号:"+new String(body));
      }
    };
